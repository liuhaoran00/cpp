    ...
    if (show_count >= show_count_obj) {
        ...
        switch (show_step) {
            ...
            case 1:
                show_step++;
                show_count_obj = 40;
                position = {190, 50, 250, 250, 250, 250, 200, 120, 168, 250, 140, 0, 0, 0, 0, 5, 5, 250, 250, 250};
                break;
            case 2:
                show_step++;
                show_count_obj = 33;
                position = {190, 50, 250, 250, 250, 250, 200, 120, 168, 250, 140, 0, 0, 0, 0, 5, 5, 5, 5, 5};
                break;
            case 3:
                show_step++;
                show_count_obj = 30;
            ...
            case 6:
                show_step++;
                show_count_obj = 2;
                position = {190, 50, 250, 250, 250, 250, 80, 120, 168, 250, 140, 0, 0, 0, 0, 5, 5, 250, 250, 250};
                break;
            default:
                show_step = 0;
                position = {128, 250, 250, 250, 250, 250, 128, 128, 128, 128, 250, 0, 0, 0, 0, 250, 250, 250, 250, 250};
